...
"""
Build a Docker image for the heating control chatbot.
"""
...
image_name = "heating-chatbot:latest"
...
def build_docker_chatbot(image_name, dockerfile_path):
    """
    Build the Docker's chatbot image (remove it before if it already exists).
    """
...
if __name__ == "__main__":
    build_docker_chatbot(image_name, dockerfile_path)
